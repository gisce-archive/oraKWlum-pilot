...
#        with before.all:
        ...
        with context("if real consumption"):
            with it ("is defined"):
                consumption = 34
                consum = Consumption("ES0031406229285001HS3F", [2016, 3, 2, 15], real=consumption)
                assert consum.consumption_real == consumption

            with it ("is not defined"):
                consumption = 34
                consum = Consumption("ES0031406229285001HS3F", [2016, 3, 2, 15], real=None)
                assert consum.consumption_real == None

        with context("if proposal consumption"):
            with it ("is defined"):
                consumption = 34
                consum = Consumption("ES0031406229285001HS3F", [2016, 3, 2, 15], proposal=consumption)
                assert consum.consumption_proposal == consumption

            with it ("is not defined"):
                consumption = 34
                consum = Consumption("ES0031406229285001HS3F", [2016, 3, 2, 15], proposal=None)
